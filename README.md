...
R package **reportbrick**, version **0.15.1**
...
Hasse R, Rosemann R (2026). "reportbrick: Reporting package for BRICK." Version: 0.15.1, <https://github.com/pik-piam/reportbrick>.
