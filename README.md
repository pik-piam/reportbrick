...
R package **reportbrick**, version **0.12.2**
...
Hasse R, Rosemann R (2025). "reportbrick: Reporting package for BRICK." Version: 0.12.2, <https://github.com/pik-piam/reportbrick>.
