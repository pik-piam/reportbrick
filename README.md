...
R package **reportbrick**, version **0.7.3**
...
Hasse R, Rosemann R (2025). "reportbrick: Reporting package for BRICK - Version 0.7.3."

A BibTeX entry for LaTeX users is

 ```latex
@Misc{,
  title = {reportbrick: Reporting package for BRICK - Version 0.7.3},
